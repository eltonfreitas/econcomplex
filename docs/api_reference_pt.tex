...
\textbf{Fun\c{c}\~{a}o} & \textbf{Descri\c{c}\~{a}o} \\
\midrule\endhead
\texttt{\footnotesize compute\_complexity(data, cols, *, method='eigenvector', presence\_test='rca', threshold=1.0, iterations=20, proximity\_type='discrete', proximity\_method='max', pop=None, compute\_coi\_cog=True, time\_col=None)} & {\small Pipeline completo: todos os indicadores a partir do DataFrame longo (suporta painel).} \\[2pt]
\bottomrule
\end{longtable}
